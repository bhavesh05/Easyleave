...
class lm extends Frame implements ActionListener,ItemListener
{
 ...
 {
  try{
  Class.forName("oracle.jdbc.driver.OracleDriver");}catch(Exception ex){System.out.println("exception in main function\n"+ex);}
  lm l=new lm();
 }
 ...
 class apply extends Dialog implements ActionListener
 {
  ...
  apply(Frame f)
  {
   ...
   setLayout(applygbl);
   applyl1=new Label("Type of Leave : ");
