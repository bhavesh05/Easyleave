...
stmt.executeUpdate("insert into staff values(733,'733','cse','9999999999','cse@gmail.com','cse','HOD',null,null,null,null,null,null,null,null)");
...
stmt.executeUpdate("insert into staff values(735,'735','ece','9999999999','ece@gmail.com','ece','HOD',null,null,null,null,null,null,null,null)");
stmt.executeUpdate("insert into staff values(105,'105','five','5555555555','five@gmail.com','mech','professor',2,2,10,10,10,null,null,null)");
stmt.executeUpdate("insert into staff values(106,'106','six','6666666666','six@gmail.com','mech','asst.professor',2,2,10,10,10,null,null,null)");
stmt.executeUpdate("insert into staff values(739,'739','mech','9999999999','mech@gmail.com','mech','HOD',null,null,null,null,null,null,null,null)");
